...
#define FUNC(ARG) call MRH_fnc_MilsimTools_SniperTraining_##ARG
...
#define SVAR(ARG1,ARG2,ARG3) setVariable [##QUOTE##MRH_SniperTraining_##ARG1##QUOTE,##ARG2,##ARG3]
#define GVAR(ARG) getVariable ##QUOTE##MRH_SniperTraining_##ARG##QUOTE
#define PLSVAR(ARG1,ARG2,ARG3) player setVariable [##QUOTE##MRH_SniperTraining_##ARG1##QUOTE,##ARG2,##ARG3]
#define PLGVAR(ARG) player getVariable ##QUOTE##MRH_SniperTraining_##ARG##QUOTE
#define MNSVAR(ARG1,ARG2,ARG3) missionNamespace setVariable [##QUOTE##MRH_SniperTraining_##ARG1##QUOTE,##ARG2,##ARG3]
#define MNGVAR(ARG) missionNamespace getVariable ##QUOTE##MRH_SniperTraining_##ARG##QUOTE
#define UISVAR(ARG1,ARG2,ARG3) uiNamespace setVariable [##QUOTE##MRH_SniperTraining_##ARG1##QUOTE,##ARG2,##ARG3]
#define UIGVAR(ARG) uiNamespace getVariable ##QUOTE##MRH_SniperTraining_##ARG##QUOTE
