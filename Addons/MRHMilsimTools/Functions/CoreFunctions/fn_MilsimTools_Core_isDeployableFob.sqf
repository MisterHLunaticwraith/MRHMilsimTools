...
"",
_statementDeploy, 
{_return = false; _MOBsource = _this select 0;_isDep=  _MOBsource getVariable ["MRH_MOBsource_MOBsourceisDeployed",false];_isDeploying =_MOBsource getVariable ["MRH_MOBsource_isNotDeploying",false]; _return = (!(_isDep) && !(_isDeploying));_return},
{},
