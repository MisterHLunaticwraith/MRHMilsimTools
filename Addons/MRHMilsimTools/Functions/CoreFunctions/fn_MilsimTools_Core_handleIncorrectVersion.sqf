...
systemChat format ["MRH Milsim Tools version mismatch: server version %1. %2 version %3",_remoteVersion,profileName,_localVersion];
...
[
    {(player == player) && (!isNull (findDisplay 46))}, 
    {
		...
		_ctrlText ctrlSetText (format ["MRH MilsimTools Warning: Version Mismatch you have version %1, server version %2. You will be returned to lobby in 30 seconds",_localVersion,_remoteVersion]);
