//Defines DebugTools
#define ADDON MRHDebugTools
#define ADDONVAR DebugTools

//Defines list of paths
#define ROOTPATH "MRHDebugTools
...
#define QFUNC(ARG) QUOTE##MRH_fnc_MilsimTools_DebugTools_##ARG##QUOTE
#define QCFUNC(ARG) QUOTE##call MRH_fnc_MilsimTools_DebugTools_##ARG##QUOTE
...
#define CTRLRSZ(ARG) [300119,##ARG##] CFUNC(SetCtrlSize)
