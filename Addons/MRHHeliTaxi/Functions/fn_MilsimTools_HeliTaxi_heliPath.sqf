...
private _toCall = 'spawn MRH_fnc_MilsimTools_HeliTaxi_LandFinal';//default value just in case
...
private _wpStatement = format ["_lastWaypoint setWaypointStatements ['true', '[(vehicle leader this),%1] %2']",_destination,_toCall];
