...
if (_candidates isEqualTo []) exitWith {diag_log "MRH_MilsimTools_HeliTaxi: no replacement caller found"; _caller};
...
diag_log format ["MRH_MilsimTools_HeliTaxi: new called assigned %1", _newCaller];
_newCaller