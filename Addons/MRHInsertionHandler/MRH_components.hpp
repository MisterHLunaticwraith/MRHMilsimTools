//Defines InsertionHandler
#define ADDON MRHInsertionHandler
#define ADDONVAR InsertionHandler

//Defines list of paths
#define ROOTPATH "\MRHInsertionHandler
...
#define FDIS(ARG) ((finddisplay 15082018) displayCtrl ##ARG##)
#define FDIS2(ARG) ((finddisplay 17082018) displayCtrl ##ARG##)
...
#define CTRLRSZ(ARG) [15082018,##ARG##] CFUNC(SetCtrlSize)
