...
_camMRHRoster attachTo [player, [0,3,3]];
...
_rankIntel = [player] call MRH_fnc_MilsimTools_Core_LocRankIntel;
...
CTRLRSZ(1203);
//set grp text
_strucuredRosterText= [[group player],true] CFUNC(GenerateRosterText);
