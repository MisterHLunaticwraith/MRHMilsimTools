...
class RscProgressMRHSoldierTab
{
	type = 8;
	style = 0;
	colorFrame[] = {0,0,0,1};
...
class RscInvisibleButtonMRHSoldierTab
{
	deletable = 0;
	fade = 0;
	access = 0;
...
class RscStructuredTextMRHSoldierTab
{
	deletable = 0;
	fade = 0;
	access = 0;
...
class RscShortcutButtonMRHSoldierTab
{
	deletable = 0;
	fade = 0;
	type = 16;
...
class RscShortcutButtonMainMRHSoldierTab
{
	color[] = 
	{
		1,
...
class RscCheckBoxMRHSoldierTab
{
	color[] = 
	{
		1,
...
class RscTextCheckBoxMRHSoldierTab
{
	colorText[] = 
	{
		1,
...
class RscButtonMenuMRHSoldierTab
{
	colorBackground[] = 
	{
		0,
...
class RscButtonMenuOKMRHSoldierTab
{
	shortcuts[] = 
	{
		"0x00050000 + 0",
...
class RscButtonMenuCancelMRHSoldierTab
{
	shortcuts[] = 
	{
		"0x00050000 + 1"
...
class RscControlsGroupMRHSoldierTab
{
	deletable = 0;
	fade = 0;
	class VScrollbar 
...
///////////
class RscMapControlMRHSoldierTab {
